...
def main(data):
   ...
   for i in range(len(data)):
      policyCount = data[i].split(" ")[0]
      policyMin   = int(policyCount.split("-")[0])
      policyMax   = int(policyCount.split("-")[1])
      policyLetter= data[i].split(" ")[1].split(":")[0]
      password    = data[i].split(" ")[2]
      letterCount = password.count(policyLetter)
      #print "{} {} {} {} {}".format(policyMin, policyMax, policyLetter, password, letterCount)
      if letterCount >= policyMin and letterCount <= policyMax:
         correctPasswords1 += 1
      if ( password[policyMin-1] == policyLetter and password[policyMax-1] != policyLetter ) or ( password[policyMin-1] != policyLetter and password[policyMax-1] == policyLetter ):
         #print data[i]
         #print "{} {} {}".format(password[policyMin-1], password[policyMax-1], password)
         correctPasswords2 += 1
   print "Correct passwords(q1) {} out of {}".format(correctPasswords1, len(data))
   print "Correct passwords(q2) {} out of {}".format(correctPasswords2, len(data))
